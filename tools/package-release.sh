...
install -Dm755 native/game-capture-gl/build/luma-opengl-capture-receiver "$staging/luma-opengl-capture-receiver"
...
install -Dm644 config/luma-hyprlock.conf "$staging/hyprlock.conf"
...
install -Dm644 packaging/wm-portals.conf "$staging/wm-portals.conf"
